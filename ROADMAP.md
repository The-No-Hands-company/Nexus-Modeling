...
| M4: Advanced Pipelines | In Progress | High | v0.4 | GPU timestamps done (Month 16); CPU cull timing done (Month 17); TAA Renderer wiring done (Month 18); async-compute denoiser scheduling done (Month 20); RT/mesh-shader production deferred |
...
2. M4 continuation — DLSS/XeSS perf gate; upscaler scheduling (mirrors denoiser pattern).
