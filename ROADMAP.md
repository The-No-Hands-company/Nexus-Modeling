...
| M4: Advanced Pipelines | In Progress | High | v0.4 | GPU timestamps done (Month 16); CPU cull timing done (Month 17); TAA done (Month 18); async-compute denoiser+upscaler scheduling done (Month 20–21); DLSS/XeSS perf gate done (Month 21); RT/mesh-shader production deferred |
...
1. v0.3 release — changelog drafted; CI suite at 100% (Month 19); package manifest.
2. M4 completion — RT/mesh-shader production path; final M4 exit criteria review.
3. M5 contributor scale-up — onboarding docs, API surface coverage expansion.
