...
| M4: Advanced Pipelines | In Progress | High | v0.4 | GPU timestamps done (Month 16); CPU cull timing done (Month 17); TAA Renderer wiring done (Month 18); RT/mesh-shader production deferred |
...
1. v0.3 release — changelog drafted (Month 18); package manifest, CI smoke suite hardening.
2. M4 continuation — async-compute denoiser scheduling + DLSS/XeSS perf gate.
