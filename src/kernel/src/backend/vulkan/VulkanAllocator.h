...
// NullAllocator is defined in backend/null/NullAllocator.h (no Vulkan dependency).
// Include it here so callers that already include VulkanAllocator.h still get it.
} // namespace nexus::gfx
#include "../null/NullAllocator.h"
namespace nexus::gfx {
