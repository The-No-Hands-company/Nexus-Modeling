...
SCENARIO_ID="parametric_rectangle_replay"
FILTER="ParametricFoundation.SketchSampleGeneratorBuildsAndSolvesRectangleLikeModel:ParametricFoundation.ReplaySolveIsDeterministicAcrossLoads"
