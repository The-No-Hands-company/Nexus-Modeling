...
SCENARIO_ID="softrast_parametric_render"
FILTER="SoftrastScenario.ParametricSketchRender"
...
if [[ ! -x "${TEST_BIN}" ]]; then
    ...
    if ! NEXUS_SCENARIO_PARAMETRIC_RENDER=1 \
...
frame_hash_file="${ARTIFACT_DIR}/parametric_render/frame_hash.txt"
