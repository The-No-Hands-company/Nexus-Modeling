...
SCENARIO_ID="softrast_sphere_gouraud"
FILTER="SoftrastScenario.RenderSphereGouraud"
...
if [[ ! -x "${TEST_BIN}" ]]; then
    ...
    if ! SOFTRAST_SPHERE_ARTIFACT_DIR="${ARTIFACT_DIR}" \
