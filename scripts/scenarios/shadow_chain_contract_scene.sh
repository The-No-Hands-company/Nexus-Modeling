...
SCENARIO_ID="shadow_chain_contract_scene"
FILTER="RendererBehavior.ShadowPassRunsBeforeGeometryAndTransitionsForSampling:RendererBehavior.ShadowPassBindingDescTracksTargetExtentAndSamplingState:RendererBehavior.ShadowDescriptorsTrackEnableShadowsToggleDeterministically"
