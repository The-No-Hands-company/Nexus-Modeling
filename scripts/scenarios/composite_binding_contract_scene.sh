...
SCENARIO_ID="composite_binding_contract_scene"
FILTER="RendererBehavior.CompositePassBindingDescTracksCoreMaterialAndShadowInputs:RendererBehavior.CompositePathBindsDescriptorSetInsteadOfPushConstants:RendererBehavior.CompositeAndShadowDescriptorSetsStayDistinctWithinFrame"
