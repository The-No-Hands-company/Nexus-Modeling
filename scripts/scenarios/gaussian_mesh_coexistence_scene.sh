...
SCENARIO_ID="gaussian_mesh_coexistence_scene"
FILTER="GaussianSplatting.CoexistenceWithMeshNodeInSameScene:GaussianSplatting.SceneNodeConstructFromCloud:GaussianSplatting.RepresentationTypeVariantsAreDistinct"
